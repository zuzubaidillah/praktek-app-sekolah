            ...
            <form class="" action="proses_update.php?id=<?=$id?>" method="post">
                <div class="row">
                    <div class=" mb-3 col-md-6">
                        ...
                        <input type="text" class="form-control" id="txtid" readonly name="txtid" placeholder="ID dibuat oleh sistem" value="<?=$getId?>">
                        <div id="txtid" class="form-text">Diisi Oleh Sistem</div>
                    </div>
                    <div class=" mb-3 col-md-6">
                        <label for="txtnama" class="form-label">Nama Sekolah</label>
                        <input value="<?=$getNama?>" required type="text" class="form-control" id="txtnama" name="txtnama" placeholder="Masukan Nama">
                        <div id="txtnama" class="form-text">Harus diisi</div>
                    </div>
                    <div class=" mb-3 col-md-6">
                        <label for="txttelpon" class="form-label">Telpon</label>
                        <input value="<?=$getTelpon?>" required type="text" class="form-control" id="txttelpon" name="txttelpon" placeholder="Masukan Nomor Telpon">
                        <div id="txttelpon" class="form-text">Harus diisi</div>
                    </div>
                    <div class="mb-3 col-md-12">
                        <label for="txtalamat" class="form-label">Alamat</label>
                        <textarea required type="date" class="form-control" id="txtalamat" name="txtalamat"><?=$getAlamat?></textarea>
